            ...
            <div class="white-box">
                ...
                <div class="form-group">
                    <div class="col-xs-12" style="padding-top: 10px">
                        <center>
                            <img src="<?php echo base_url() ?>assets/images/unipdu.png" style="width: 100px; height: 100px">
                ...
                <div class="form-group text-center m-t-40">
                    <div class="col-xs-12">
                        ...
                        <a href="<?php echo base_url(); ?>" class="btn btn-danger btn-block btn-lg">Kembali ke website utama</a>
                    </div>
                </div>
            </form>
        </div>
        <footer class="footer text-center">
            <?php echo date('Y') ?> © hurimen
        </footer>
    </div>
</section>
<!-- jQuery -->
